  ...
  return (
    <div className="marketing-shell">
      <header className="marketing-header">
        ...
        <nav>
          <a href="#platform">{t("home.platform")}</a>
        ...
        <div className="marketing-actions">
          ...
          <Link className="primary-button header-cta" to="/register">
            {t("home.getStarted")}
          </Link>
        </div>
      </header>
          ...
          <div className="hero-art" aria-hidden="true">
            ...
            <div className="hero-panel">
              ...
              <div className="hero-panel-title">
                <span>{t("home.teamPerformance")}</span>
                <strong>+24.8%</strong>
              </div>
              <div className="chart">
                <i></i>
        ...
        <section className="feature-section" id="features">
          ...
          <div className="feature-grid">
            <article>
              ...
              <p>{t("home.featureOneDescription")}</p>
            </article>
            <article>
              <span className="feature-number">02</span>
              <h3>{t("home.featureTwoTitle")}</h3>
              <p>{t("home.featureTwoDescription")}</p>
            </article>
            <article>
              <span className="feature-number">03</span>
              <h3>{t("home.featureThreeTitle")}</h3>
              <p>{t("home.featureThreeDescription")}</p>
            </article>
          </div>
        </section>
        <section className="closing-section" id="about">
          <div>
            <span className="eyebrow light">{t("home.readyEyebrow")}</span>
            <h2>{t("home.readyTitle")}</h2>
          </div>
          <Link className="primary-button" to="/register">
            {t("home.enterWorkspace")} <span>↗</span>
          </Link>
        </section>
      </main>
      <SiteFooter dark />
